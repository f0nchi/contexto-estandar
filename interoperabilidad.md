...
| **Permisos / gobernanza** | Excluido por diseño: un dueño y su IA. En evaluación para v1.1: sello de integridad del archivo exportado | No cubierto | El más fuerte: cuatro niveles por sección, tres roles en el plan Company | Parcial: control de qué se comparte al exportar y sello SHA-256 |
...
| **Descubrimiento** | Pendiente: hoy la carpeta se entrega en mano, sin ubicación conocida donde un agente ajeno pueda buscarla | Resuelto: URL bien conocida en el dominio, más registro hosteado que firma los archivos y los sirve por MCP | Herencia por directorios dentro de un proyecto | No verificado en detalle |
...
**Pendiente:** descubrimiento, una forma de publicar la carpeta en un dominio para que un agente ajeno la encuentre sin que nadie se la pase, que hoy el Brand Context Protocol resuelve y este estándar no. Herencia entre marca madre, producto y submarca. Verificación de juicio con casos retenidos. En evaluación: sello de integridad del archivo exportado.
